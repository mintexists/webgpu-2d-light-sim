...
const pipeline = device.createRenderPipeline({
    ...
    fragment: {
        module,
        entryPoint: 'fs',
        targets: [{ format: presentationFormat }, { format: 'rgba16float' }],
    }
});
...
const bindGroup = device.createBindGroup({
    ...
    entries: [
        ...
        { binding: 2, resource: { buffer: linesBuffer } },
    ],
});
...
let render = async () => {
    ...
    encoder.copyTextureToTexture({ texture: outputTexture }, { texture: texture }, [size, size])
